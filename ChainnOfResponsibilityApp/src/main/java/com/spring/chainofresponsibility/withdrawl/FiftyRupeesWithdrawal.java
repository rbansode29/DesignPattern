...
public class FiftyRupeesWithdrawal extends RupeeWithdrawal implements AmountWithdrawal {

	public FiftyRupeesWithdrawal() {
		super();
	}
	...
	public void doAmountCalculation(Integer p_remainingAmount) {		
		...
		if (null != p_totalAllowedAmount && null != p_remainingAmount) {
			...
			if (null != l_remainingAmount && l_remainingAmount > 0) {
				System.out.println("Please enter the amount multipal of 50");
			}
